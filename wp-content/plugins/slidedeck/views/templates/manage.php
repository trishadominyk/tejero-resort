...
<div class="" id="slidedeck_lens_management">
    ...
    <div class="slidedeck-header">
        ...
        <a title="Help" href="https://www.slidedeck.com/documentation/?utm_source=sd5_documentation&utm_campaign=sd5_lite&utm_medium=link#installing-templates" target="_blank" class="help-icon" >
            <span class=""></span>
        </a>
    </div>
