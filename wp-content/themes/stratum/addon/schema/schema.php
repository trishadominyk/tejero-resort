...
class Stratum_Schema {
	 ...
	 * @since 1.0.0
	 *
	 * @see stratum_get_attr()
	 */
	public static function initiate() {
		add_filter( 'stratum_get_attr_head', array( __CLASS__, 'head' ) );
		add_filter( 'stratum_get_attr_body', array( __CLASS__, 'body' ) );
		add_filter( 'stratum_get_attr_site-header', array( __CLASS__, 'site_header' ) );
		add_filter( 'stratum_get_attr_site-title', array( __CLASS__, 'site_title' ) );
		add_filter( 'stratum_get_attr_site-description', array( __CLASS__, 'site_description' ) );
		add_filter( 'stratum_get_attr_main-navigation', array( __CLASS__, 'main_navigation' ) );
		add_filter( 'stratum_get_attr_header-menu', array( __CLASS__, 'main_navigation' ) );
		add_filter( 'stratum_get_attr_footer-menu', array( __CLASS__, 'main_navigation' ) );
		add_filter( 'stratum_get_attr_social-menu', array( __CLASS__, 'main_navigation' ) );
		add_filter( 'stratum_get_attr_content-area', array( __CLASS__, 'content_area' ) );
		add_filter( 'stratum_get_attr_site-main', array( __CLASS__, 'site_main' ) );
		add_filter( 'stratum_get_attr_post', array( __CLASS__, 'post' ) );
		add_filter( 'stratum_get_attr_primary-sidebar', array( __CLASS__, 'primary_sidebar' ) );
		add_filter( 'stratum_get_attr_site-footer', array( __CLASS__, 'site_footer' ) );
		add_filter( 'stratum_get_attr_entry-title', array( __CLASS__, 'entry_title' ) );
		add_filter( 'stratum_get_attr_entry-content', array( __CLASS__, 'entry_content' ) );
		add_filter( 'stratum_get_attr_entry-date', array( __CLASS__, 'entry_date' ) );
		add_filter( 'stratum_get_attr_modified-entry-date', array( __CLASS__, 'modified_entry_date' ) );
		add_filter( 'stratum_get_attr_author', array( __CLASS__, 'author' ) );
		add_filter( 'stratum_get_attr_url', array( __CLASS__, 'url' ) );
		add_filter( 'stratum_get_attr_name', array( __CLASS__, 'name' ) );
		add_filter( 'stratum_get_attr_tags-links', array( __CLASS__, 'tags_links' ) );
		add_filter( 'stratum_get_attr_comment-inner', array( __CLASS__, 'comment_inner' ) );
		add_filter( 'stratum_get_attr_comment-author', array( __CLASS__, 'comment_author' ) );
		add_filter( 'stratum_get_attr_comment-time', array( __CLASS__, 'comment_time' ) );
		add_filter( 'stratum_get_attr_comment-content', array( __CLASS__, 'comment_content' ) );
		add_filter( 'stratum_get_attr_page-header', array( __CLASS__, 'page_header' ) );
		add_filter( 'stratum_get_attr_page-title', array( __CLASS__, 'site_title' ) );
		add_filter( 'stratum_get_attr_taxonomy-description', array( __CLASS__, 'site_description' ) );
		add_filter( 'stratum_get_attr_search-form', array( __CLASS__, 'search_form' ) );
		add_filter( 'stratum_get_attr_search-field', array( __CLASS__, 'search_field' ) );
