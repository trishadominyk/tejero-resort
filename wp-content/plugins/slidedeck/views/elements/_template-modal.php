...
*/
?>
<h3><?php _e( $title, $namespace ); ?><a style="text-decoration:none;cursor:pointer;" title="Help" href="https://www.slidedeck.com/documentation/?utm_source=sd5_documentation&utm_campaign=sd5_lite&utm_medium=link#template-management" target="_blank" class="help-icon">
        <span class=""></span>
    </a></h3>
