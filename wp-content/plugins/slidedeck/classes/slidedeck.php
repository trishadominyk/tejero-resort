...
/**
    ...
    final public function render( $id, $styles = array(), $include_lens_files = true, $preview = false, $echo_js = false, $start = false, $post = null, $front_page ) {
		...
		if( $slidedeck['options']['auto_height'] || $slug === "titles" || $slug === "polarad" || $slug === "prime" || $slug === "parfocal" || $current_lens === 'parallax' || $current_lens === 'tiled' ||$current_lens === 'layerpro' ){
    ...
    // Default navigation
      ...
      */  
		...
		'o-town','classic','polarad','reporter'
		);
