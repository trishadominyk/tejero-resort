	...
	function process_template( $nodes, $slidedeck, $deck_iteration )
	{
		...
		if ( isset( $slide_types[$slide_type] ) ) {
			...
			if ( file_exists( $template ) ) {
				...
				if ( isset( $video_meta ) && ( $slidedeck['lens'] === 'prime' || $slidedeck['lens'] === 'parfocal' || $slidedeck['lens'] === 'parallax' || $slidedeck['lens'] === 'tiled' || $slidedeck['lens'] === 'transitionpro' || $slidedeck['lens'] === 'layerpro' ) ) {
			...
			case "html5":
				...
				$source=$nodes['video'];
				 ...
				 $video_container = '<video width="320" height="240" controls class="youtube video-container">
		...
		break;
                            ...
                            case "vimeo":
                                ...
                                if($slidedeck['lens'] === 'layerpro') {
                                    ...
                                    $video_container .= "<iframe id='vimeoiFrame-video__{$video_meta['id']}__{$slidedeck['id']}-{$deck_iteration}' src='http://player.vimeo.com/video/{$video_meta['id']}?api=1&amp;byline=0&amp;title=0&amp;portrait=0&amp;player_id=vimeoiFrame-video__{$video_meta['id']}__{$slidedeck['id']}-{$deck_iteration}' width='100%' height='100%' frameborder='0'></iframe>";
                                }
                            ...
                            case "youtube":
                                if($slidedeck['lens'] === 'layerpro') {
                                    ...
                                    $video_container = "<iframe id='video__{$video_meta['id']}__{$slidedeck['id']}-{$deck_iteration}' class='youtube video-container' src='http://www.youtube.com/embed/{$video_meta['id']}?enablejsapi=1&amp;byline=0&amp;title=0&amp;portrait=0&amp;' width='100%' height='100%' frameborder='0' title='YouTube video player' allowfullscreen='1'></iframe>";
                                }
                            ...
                            case "dailymotion":
                                if($slidedeck['lens'] === 'layerpro') {
                                    ...
                                    $video_container = "<iframe id='vimeoiFrame-video__{$video_meta['id']}__{$slidedeck['id']}-{$deck_iteration}' src='http://www.dailymotion.com/embed/video/{$video_meta['id']}?api=1&amp;byline=0&amp;title=0&amp;portrait=0&amp;player_id=vimeoiFrame-video__{$video_meta['id']}__{$slidedeck['id']}-{$deck_iteration}' width='100%' height='100%' frameborder='0' ></iframe>";
                                }
