...
<div id="create-dynamic-slidedeck" class="create-slidedeck">
  ...
  <div class="slidedeck-inner">
	    <h4>Dynamic Source<a style="text-decoration:none;cursor:pointer;" title="Help" href="https://www.slidedeck.com/documentation/?utm_source=sd5_documentation&utm_campaign=sd5_lite&utm_medium=link#dynamic-content-type-2" target="_blank" class="help-icon">
                <span class=""></span>
            </a></h4>
