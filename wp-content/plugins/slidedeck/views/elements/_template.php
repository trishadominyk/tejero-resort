...
<div class="lens">
    ...
    <div class="inner">
	        ...
	        <span class="thumbnail-inner" style="background-image:url(<?php echo $template['thumbnail-large']; ?>);"></span>
	        
	    
	        </span>
	    
	    
	    <h4><?php echo $template['meta']['name']; ?>
	    ...
	    <p><?php echo $template['meta']['description']; ?></p>
    ...
    <div class="actions">
        <form action="" method="post">
            ...
            <?php if( !$template['is_protected'] ): ?>
            
            	<?php wp_nonce_field( "{$namespace}-delete-template" ); ?>
            	<input type="hidden" name="lens" value="<?php echo $template['slug']; ?>" />
