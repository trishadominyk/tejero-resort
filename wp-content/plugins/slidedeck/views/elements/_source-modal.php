...
*/
?>
<h3><?php _e( $title, $namespace ); ?><a style="text-decoration:none;cursor:pointer;" title="Help" href="https://www.slidedeck.com/documentation/?utm_source=sd5_documentation&utm_campaign=sd5_lite&utm_medium=link#source-management" target="_blank" class="help-icon">
        <span class=""></span>
    </a></h3>
            ...
            <li class="source<?php if( in_array( $source->name, $disabled_sources ) ) echo ' disabled'; ?>">
                <label>
                    <span class="thumbnail">
                        <img src="<?php slidedeck_source_icon_url( $source ); ?>" alt="<?php echo $source->label; ?>" />
                    </span>
