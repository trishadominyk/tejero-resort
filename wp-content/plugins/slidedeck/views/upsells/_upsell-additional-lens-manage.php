        ...
        <div class="lens add-lens">
            <div class="inner">
                ...
                <div class="upgrade-button-cta">
                    ...
                    <a title="Help" href="https://www.slidedeck.com/documentation/?utm_source=sd5_documentation&utm_campaign=sd5_lite&utm_medium=link#<?php echo $slug;?>" target="_blank" class="help-icon" >
                        <span class=""></span>
                    </a>  
                </div>
            </div>
