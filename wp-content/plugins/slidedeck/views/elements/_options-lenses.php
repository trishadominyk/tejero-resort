...
<?php foreach( $lenses as &$lens ): ?>
    <label class="lens<?php if( $lens['slug'] == $slidedeck['lens'] ) echo ' selected'; ?>">
        ...
        <span class="title"><?php echo $lens['meta']['name']; ?><a style="text-decoration:none;cursor:pointer;" title="Help" href="https://www.slidedeck.com/documentation/?utm_source=sd5_documentation&utm_campaign=sd5_lite&utm_medium=link#<?php echo $lens['slug'];?>" target="_blank" class="help-icon">
                <span class=""></span>
            </a></span>
