...
slidedeck_fullwidth = function() {
		    ...
		    d.frame.find(".sd-fullwidth-active").css({'width': slidedeck_width + 'px !important' , 'margin-top' : 0+'px'}); 	
                   ...
                   if(slidedeck_width < 700) {
                    ...
                    if( !jQuery( ".slidedeck-fullwidth-container" ).length ) {
                        parent_frame.after('<div class="slidedeck-fullwidth-container" style="width: 100%; height: ' + ( parent_frame_height ) + 'px;"></div>');
                    }
