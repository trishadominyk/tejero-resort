...
class SlideDeckPlugin {
  ...
  $current_user = wp_get_current_user();
    ...
    function slidedeck_custom_css_field( $slidedeck ) {
        ...
        $help_message = sprintf(__('See  %1$sour knowlegde base%2$s for tips on using this section and writing selectors.'), "<a href='http://support.slidedeck.com/entries/96366448-Custom-CSS-Options-Panel' target='_blank'>", '</a>');
    ...
    function slidedeck_upload_premium_templates( ) {
        ...
        error_log(print_r($prem_template), true);
        $contextOptions = array(
            "ssl" => array(
                "verify_peer"      => false,
                "verify_peer_name" => false,
